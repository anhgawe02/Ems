...
Public Class RptEMS_Lien_Tinh_Lien_Ke
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RptEMS_Lien_Tinh_Lien_Ke.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Buu_Dien_Tinh As CrystalDecisions.Shared.IParameterField
        Get
...
Public Class CachedRptEMS_Lien_Tinh_Lien_Ke
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptEMS_Lien_Tinh_Lien_Ke = New RptEMS_Lien_Tinh_Lien_Ke
        rpt.Site = Me.Site
        Return rpt
    End Function
