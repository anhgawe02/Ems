...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSuaChuaE2Den))
        ...
        Me.cbPhanLoaiCanSua.TabIndex = 11
        ...
        Me.btnSuaE2Loi.Appearance = Appearance1
        ...
        Me.lblCanSua.Appearance = Appearance2
        ...
        Me.cbTuiSoCanSua.Location = New System.Drawing.Point(296, 152)
        Me.cbTuiSoCanSua.Name = "cbTuiSoCanSua"
        Me.cbTuiSoCanSua.Size = New System.Drawing.Size(48, 21)
        ...
        Me.btnXoaE2.Appearance = Appearance3
        ...
        Me.cbTuiSoSua.Location = New System.Drawing.Point(296, 152)
        Me.cbTuiSoSua.Name = "cbTuiSoSua"
        Me.cbTuiSoSua.Size = New System.Drawing.Size(48, 21)
        Me.cbTuiSoSua.TabIndex = 14
        ...
        Me.cbChuyenThuSua.Location = New System.Drawing.Point(208, 152)
        Me.cbChuyenThuSua.Name = "cbChuyenThuSua"
        Me.cbChuyenThuSua.Size = New System.Drawing.Size(80, 21)
        Me.cbChuyenThuSua.TabIndex = 13
        Me.cbChuyenThuSua.ValueMember = "So_Chuyen_Thu"
        '
        'lblSua
        '
        Appearance5.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(192, Byte), CType(192, Byte))
        Appearance5.FontData.BoldAsString = "True"
        Me.lblSua.Appearance = Appearance5
        ...
        Me.btnSua.Appearance = Appearance6
        ...
        Me.Label17.Location = New System.Drawing.Point(296, 128)
        ...
        Me.Label18.Location = New System.Drawing.Point(208, 128)
...
#Region "Khai Bao"
    ...
    'Hieu chinh chuyen thu dung chung 
...
#Region "FORM LOAD"
    Private Sub FrmSuaChuaE2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Không cho phép sửa phân loại chuyến thư
        cbPhanLoaiSua.Enabled = False
    End Sub
...
#Region "Bild data Duong_thu,CHuyen_Thu,Tui_so"
    ...
    Private Sub ChuyenThuCanSua_DataBind()
        ...
        cbChuyenThuCanSua.DataSource = myChuyen_Thu_Den.Danh_Sach_Chuyen_Thu_den(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), Phan_Loai_Chuyen_Thu)
...
#End Region
    ...
    Private Sub cbChuyenThuCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbChuyenThuCanSua.Validated
        If cbChuyenThuCanSua.Text <> "" Then
            ...
            If chk_Id_Chuyen_thu = True Then
                Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Chuyen_Thu_Den_Lay_Id_Chuyen_Thu_Theo_Phan_Loai_Chuyen_Thu(Id_Duong_Thu, Ngay_Khai_Thac_Can_Sua, cbChuyenThuCanSua.Text, cbPhanLoaiCanSua.Text).Id_Chuyen_Thu
                If (Id_Chuyen_Thu.Length = 0) Then
                    CMessageBox.Show("Thông tin về chuyến thư này không có,bạn cần kiểm tra lại chính xác chuyến thư cần sửa chữa")
                    cbPhanLoaiCanSua.Focus()
                    Exit Sub
                End If
                ''cbPhanloaisua
                Dim PhanLoaiChuyenThu As String
                PhanLoaiChuyenThu = Id_Chuyen_Thu.Remove(0, Id_Chuyen_Thu.Length - 2)
                Tao_Bang_Phan_Loai_Chuyen_Thu()
                cbPhanLoaiSua.Text = PhanLoaiChuyenThu
    ...
    Private Sub cbTuiSoCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbTuiSoCanSua.Validated
        If cbTuiSoCanSua.Text <> "" And cbChuyenThuCanSua.Text <> "" And cbDuongThuCanSua.Text <> "" Then
            ...
            End If
            'Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Lay_Id_Chuyen_Thu(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), cbChuyenThuCanSua.Value).Id_Chuyen_Thu
            Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Chuyen_Thu_Den_Lay_Id_Chuyen_Thu_Theo_Phan_Loai_Chuyen_Thu(Id_Duong_Thu, Ngay_Khai_Thac, cbChuyenThuCanSua.Text, cbPhanLoaiCanSua.Text).Id_Chuyen_Thu
    ...
    Private Sub cbPhanLoaiCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbPhanLoaiCanSua.Validated
        If (cbDuongThuCanSua.Text = "") Then
            ...
            Exit Sub
        End If
        If (cbPhanLoaiCanSua.Text = "" Or cbPhanLoaiCanSua.Value = "") Then
            CMessageBox.Show("Chưa có thông tin về loại chuyến thư")
            cbPhanLoaiCanSua.Focus()
            Exit Sub
        End If
        ...
        Dim Phan_Loai_Chuyen_Thu As String = cbPhanLoaiCanSua.Text
        '''   cbChuyenThuCanSua bind
        If (myChuyen_Thu_Den.Danh_Sach_Chuyen_Thu_den(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), Phan_Loai_Chuyen_Thu).Tables(0).Rows.Count < 1) Then
            CMessageBox.Show("Hiện tại ngày E2 của đường thư " & cbDuongThuCanSua.Text & " không tồn tại loại chuyến thư " & cbPhanLoaiCanSua.Text)
            cbDuongThuCanSua.Focus()
            Exit Sub
        Else
            cbChuyenThuCanSua.DataSource = myChuyen_Thu_Den.Danh_Sach_Chuyen_Thu_den(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), Phan_Loai_Chuyen_Thu).Tables(0)
            cbChuyenThuCanSua.DataBind()
            '''   cbChuyenThuSua bind
            cbChuyenThuSua.DataSource = myChuyen_Thu_Den.Danh_Sach_Chuyen_Thu_den(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), Phan_Loai_Chuyen_Thu).Tables(0)
            cbChuyenThuSua.DataBind()
        End If
...
#Region "THONG TIN SUA"
    ...
    Private Sub cbDuongThuSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbDuongThuSua.Validated
        If cbDuongThuSua.Text <> "" Then
            ...
            'lblSua
            lblSua.Text = "                 Chua điền đầy đủ dữ liệu" & vbNewLine & "BC khai thác: " & GTen_Buu_Cuc_Khai_Thac & vbNewLine & "Tổng số E2: " & Tong_So_E2 & ";  Tổng E1: " & Tong_So_E1 & ";  Trọng lượng: " & Tong_KLBP
        End If
    End Sub
    Private Sub cbPhanLoaiSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbPhanLoaiSua.Validated
        ...
        Dim Id_Duong_Thu As String = myDuong_Thu_Den.Select_Id_Duong_Thu_Den(GBuu_Cuc_Khai_Thac, Convert.ToInt32(cbDuongThuSua.Text))
        Dim Phan_Loai_Chuyen_Thu As String = cbPhanLoaiSua.Text
        '''   cbChuyenThuSua bind
        cbChuyenThuSua.DataSource = myChuyen_Thu_Den.Danh_Sach_Chuyen_Thu_den(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacSua.DateTime), Phan_Loai_Chuyen_Thu).Tables(0)
        cbChuyenThuSua.DataBind()
    End Sub
    ...
    Private Sub btnXoaE2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXoaE2.Click
        ...
        If chk_Id_Chuyen_thu = True Then
            ...
            If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
                ...
                'Tao chi tiet truoc
                myChi_Tiet_Truoc = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(myE2_Den_Chi_Tiet_Ghi_Log.Id_Duong_Thu, myE2_Den_Chi_Tiet_Ghi_Log.Ngay_Dong, cbPhanLoaiCanSua.Value, cbChuyenThuCanSua.Text, cbTuiSoCanSua.Text, myE2_Den_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Den_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
                'Tao chi tiet sau
                myChi_Tiet_Sau = ""
                '==============================================================================   
...
#Region "SUA"
    Private Sub btnSua_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSua.Click
        'Không sửa loại chuyến thư được
        '' Thông tin cần sửa
        Dim Tui_So As Integer = cbTuiSoCanSua.Text
        Dim Gio As Integer = myHamdungchung.ConvertTimeToInt(txtGioKhaiThacCanSua.Value)
        Dim Ngay_Khai_Thac As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.Value)
        Dim Id_Duong_Thu As String = myDuong_Thu_Den.Select_Id_Duong_Thu_Den(GBuu_Cuc_Khai_Thac.ToString, cbDuongThuCanSua.Text)
        Dim Ca_Ke_Toan As Integer = cbCaKeToanCanSua.Value
        Dim Ngay_Ke_Toan As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKeToan.Value)
        Dim Chuyen_Thu_Can_Sua As Integer = cbChuyenThuCanSua.Value
        Dim Phan_Loai_Chuyen_Thu As String = cbPhanLoaiCanSua.Text
        Dim Id_Ca As String = myCa_San_Xuat.Lay_Id_Ca(GBuu_Cuc_Khai_Thac, Ngay_Ke_Toan, Ca_Ke_Toan).Id_Ca
        If Id_Duong_Thu Is Nothing Then
            CMessageBox.Show("Không tồn tại đường thư này bạn phải vào bảng Đường Thư Đến để cập nhật.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Chuyen_Thu_Den_Lay_Id_Chuyen_Thu_Theo_Phan_Loai_Chuyen_Thu(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), cbChuyenThuCanSua.Value, Phan_Loai_Chuyen_Thu).Id_Chuyen_Thu
        Dim Id_E2 As String = myE2_Den.Lay_TT_E1(Id_Chuyen_Thu, Tui_So).Id_E2
        ' Lấy thông tin của chuyến thư
        Dim So_Chuyen_thu As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).So_Chuyen_Thu
        Dim Ngay_Dong As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Ngay_Dong
        Dim Gio_Dong As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Gio_Dong
        Dim Ngay_Nhan As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Ngay_Nhan
        Dim Gio_Nhan As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Gio_Nhan
        Dim Tong_So_Tui As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_So_Tui
        Dim Tong_So_BP As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_So_BP
        Dim Tong_KL As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_KL
        Dim Tong_KLBP As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_KLBP
        Dim Tong_Cuoc_COD As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_Cuoc_COD
        Dim Tong_Cuoc_DV As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_Cuoc_DV
        Dim Tong_Cuoc As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Tong_Cuoc
        Dim HH_Phat_Hanh As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).HH_Phat_Hanh
        Dim HH_Phat_Tra As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).HH_Phat_Tra
        Dim Dong_F As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Dong_F
        Dim Truyen_Khai_Thac As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Truyen_Khai_Thac
        Dim Truyen_Doi_Soat As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Truyen_Doi_Soat
        Dim Ngay_He_Thong As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Ngay_He_Thong
        Dim Chot_Sl As Integer = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu).Chot_Sl
        ' Kiểm tra chốt số liệu
        Dim Chot_So_Lieu As Boolean = myE2_Den.Chot_So_Lieu(Id_E2)
        If Chot_So_Lieu = True Then
            CMessageBox.Show("Ðã chốt số liệu, bạn không thể sửa túi này.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        '' Thông tin sửa
        Dim Ngay_Khai_Thac_Sua As Integer
        If dtpNgayKhaiThacSua.Text = "" Then 'Không nhập ngày cần sửa
            MessageBox.Show("Không được để trống ngày trên bản kê E2!!!")
            Exit Sub
        Else
            Ngay_Khai_Thac_Sua = myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacSua.Value)
        End If
        Dim Gio_Sua As Integer
        If txtGioKhaiThacSua.Text = ":" Then ' để trống giờ trên bản kê E2
            MessageBox.Show("Không được để trống giờ trên bản kê E2!!!")
            Exit Sub
        Else
            Gio_Sua = myHamdungchung.ConvertTimeToInt(txtGioKhaiThacSua.Value)
        End If

        Dim Id_Duong_Thu_Sua As String = myDuong_Thu_Den.Select_Id_Duong_Thu_Den(GBuu_Cuc_Khai_Thac.ToString, cbDuongThuSua.Text)
        Dim Loai_Chuyen_Thu_Sua As String = Convert.ToString(cbPhanLoaiSua.Text)
        Dim Chuyen_Thu_Sua As Integer = Convert.ToInt32(cbChuyenThuSua.Text)
        If Gio_Sua = 0 Then
            Gio_Sua = Gio
        End If
        Dim Tui_So_Sua As Integer = cbTuiSoSua.Text
        Dim Id_Chuyen_Thu_Sua As String = CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Phan_Loai_Chuyen_Thu)
        Dim Id_E2_Sua As String = CreateId_E2(CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua), Tui_So_Sua)
        Dim Chk_Id_E2 As Boolean = myE2_Den.IsExist_E2_Den(Id_Chuyen_Thu_Sua, Tui_So_Sua)
        Dim Ca_Ke_Toan_Sua As Integer = cbCaKeToanSua.Text
        Dim Ngay_Ke_Toan_Sua As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKeToanSua.Value)
        Dim Chk_Id_Ca As Boolean = myCa_San_Xuat.Ca_San_Xuat_Kiem_Tra(GBuu_Cuc_Khai_Thac, Ngay_Ke_Toan_Sua, Ca_Ke_Toan_Sua)
        If Chk_Id_Ca = False Then
            CMessageBox.Show("Ca sản xuất này không tồn tại.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
        End If
        Dim Id_Ca_Sua As String = myCa_San_Xuat.Lay_Id_Ca(GBuu_Cuc_Khai_Thac, Ngay_Ke_Toan_Sua, Ca_Ke_Toan_Sua).Id_Ca
        Dim chk_Id_Chuyen_thu As Boolean = myChuyen_Thu_Den.IsExist_Chuyen_Thu_Den(Id_Duong_Thu_Sua, cbChuyenThuSua.Text, Ngay_Khai_Thac_Sua)
        If chk_Id_Chuyen_thu = True Then 'Nếu đã tồn tai  Id_Chuyen_Thu
            If Chk_Id_E2 = True Then ' Chỉ sửa thông tin về ngày đóng,giờ đóng ,ca sản xuất
                'Dim Str As String = "   Bạn có muốn cập nhập bản kê:" & vbNewLine & "Ngày: " & dtpNgayKhaiThacCanSua.DateTime.Date & " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio) & vbNewLine & "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & ", Ca kt: " & Ca_Ke_Toan & vbNewLine & "Đường thư: " & cbDuongThuCanSua.Text & ", chuyến thư: " & cbChuyenThuCanSua.Text & ", túi số: " & cbTuiSoCanSua.Text & "." & vbNewLine & vbNewLine & "Ngày: " & dtpNgayKhaiThacSua.DateTime.Date & " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio_Sua) & vbNewLine & "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & ", Ca kt:" & Ca_Ke_Toan_Sua & vbNewLine & "Đường thư: " & cbDuongThuSua.Text & ", chuyến thư: " & cbChuyenThuSua.Text & ", túi số: " & cbTuiSoSua.Text & "."
                'If (Id_Duong_Thu = Id_Duong_Thu_Sua And Chuyen_Thu_Can_Sua = Chuyen_Thu_Sua And Ngay_Khai_Thac = Ngay_Khai_Thac_Sua And (Gio <> Gio_Sua Or Ngay_Ke_Toan <> Ngay_Ke_Toan_Sua Or Ca_Ke_Toan <> Ca_Ke_Toan_Sua)) Then
                '    If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
                '        myChuyen_Thu_Den_Chi_Tiet = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu)
                '        myChuyen_Thu_Den_Chi_Tiet.Id_Ca = Id_Ca_Sua
                '        myChuyen_Thu_Den_Chi_Tiet.Ngay_Dong = Ngay_Khai_Thac_Sua
                '        myChuyen_Thu_Den_Chi_Tiet.Gio_Dong = Gio_Sua
                '        myChuyen_Thu_Den.Cap_Nhat(myChuyen_Thu_Den_Chi_Tiet)
                '        myChuyen_Thu_Den.Cap_Nhat_Id_Chuyen_Thu(Id_Chuyen_Thu, CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua))
                '        ' Cập nhật vào bảng E2.
                '        myE2_Den_Chi_Tiet = myE2_Den.Lay(Id_E2)
                '        myE2_Den_Chi_Tiet.Ngay_Dong = Ngay_Khai_Thac_Sua
                '        myE2_Den_Chi_Tiet.Gio_Dong = Gio_Sua
                '        myE2_Den_Chi_Tiet.Id_Ca = Id_Ca_Sua
                '        myE2_Den_Chi_Tiet.Id_Chuyen_Thu = CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua)
                '        myE2_Den.Cap_Nhat(myE2_Den_Chi_Tiet)
                '        myE2_Den.Cap_Nhat_Id_E2(Id_E2, CreateId_E2(CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua), Tui_So_Sua))
                '        ' Cập nhật vào bảng E1.
                '        myE1_Den.Cap_Nhat_Id_E1(Id_E2, CreateId_E2(CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua), Tui_So_Sua), Id_Duong_Thu, Id_Duong_Thu_Sua, Id_Chuyen_Thu, CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua), Id_Ca, Id_Ca_Sua, Ngay_Khai_Thac, Ngay_Khai_Thac_Sua, Gio, Gio_Sua)
                '        myE2_Den.Hieu_Chinh(CreateId_E2(CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua), Tui_So_Sua), True)
                '        myE2_Den.Xoa_Chuyen_Thu(Id_Chuyen_Thu)
                '        CMessageBox.Show("Ðã cập nhật thành công.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
                '        Load_Control()
                '    End If
                'Else
                CMessageBox.Show("Túi số này đã tồn tại, bạn không thể cập nhật.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
                'End If
            Else 'Thay đổi thông tin về Túi số,ngày đóng,ca sản xuất
                Dim Str As String = "   Bạn có muốn cập nhập bản kê:" & vbNewLine & "Ngày: " & dtpNgayKhaiThacCanSua.DateTime.Date & " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio) & vbNewLine & "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & ", Ca kt: " & Ca_Ke_Toan & vbNewLine & "Đường thư: " & cbDuongThuCanSua.Text & ", chuyến thư: " & cbChuyenThuCanSua.Text & ", túi số: " & cbTuiSoCanSua.Text & "." & vbNewLine & vbNewLine & "Ngày: " & dtpNgayKhaiThacSua.DateTime.Date & " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio_Sua) & vbNewLine & "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & ", Ca kt:" & Ca_Ke_Toan_Sua & vbNewLine & "Đường thư: " & cbDuongThuSua.Text & ", chuyến thư: " & cbChuyenThuSua.Text & ", túi số: " & cbTuiSoSua.Text & "."
                If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
                    myE2_Den_Chi_Tiet = myE2_Den.Lay(Id_E2)
                    ...
                    Dim myChi_Tiet_Sau As String     'Chi tiet sau khi xoa E2
                    Dim myE2_Den_Chi_Tiet_Ghi_Log As New E2_Den_Chi_Tiet  'Thong tin chi tiet cua E2 se xoa
                    myE2_Den_Chi_Tiet_Ghi_Log = myE2_Den_Chi_Tiet
                    'Tao chi tiet truoc
                    myChi_Tiet_Truoc = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(myE2_Den_Chi_Tiet_Ghi_Log.Id_Duong_Thu, myE2_Den_Chi_Tiet_Ghi_Log.Ngay_Dong, cbPhanLoaiCanSua.Value, cbChuyenThuCanSua.Text, cbTuiSoCanSua.Text, myE2_Den_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Den_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
                    'Tao chi tiet sau
                    myChi_Tiet_Sau = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(cbDuongThuSua.Value, Ngay_Khai_Thac_Sua, cbPhanLoaiSua.Value, cbChuyenThuSua.Text, cbTuiSoSua.Text, myE2_Den_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Den_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
                    '==============================================================================

                    myE2_Den_Chi_Tiet.Ngay_Dong = Ngay_Khai_Thac_Sua
                    myE2_Den_Chi_Tiet.Gio_Dong = Gio_Sua
                    myE2_Den_Chi_Tiet.Id_Duong_Thu = Id_Duong_Thu_Sua
                    myE2_Den_Chi_Tiet.Tui_So = Tui_So_Sua
                    myE2_Den_Chi_Tiet.Id_Ca = Id_Ca_Sua
                    myE2_Den_Chi_Tiet.Id_Chuyen_Thu = Id_Chuyen_Thu_Sua
                    myE2_Den.Cap_Nhat(myE2_Den_Chi_Tiet)

                    ' Cập nhật thêm vào bảng Tmp_E2_Den
                    myTmp_E2_Den_Chi_Tiet = myTmp_E2_Den.Lay(Id_E2)
                    myTmp_E2_Den_Chi_Tiet.Ngay_Dong = Ngay_Khai_Thac_Sua
                    myTmp_E2_Den_Chi_Tiet.Gio_Dong = Gio_Sua
                    myTmp_E2_Den_Chi_Tiet.Id_Duong_Thu = Id_Duong_Thu_Sua
                    myTmp_E2_Den_Chi_Tiet.Tui_So = Tui_So_Sua
                    myTmp_E2_Den_Chi_Tiet.Id_Ca = Id_Ca_Sua
                    myTmp_E2_Den_Chi_Tiet.Id_Chuyen_Thu = Id_Chuyen_Thu_Sua
                    myTmp_E2_Den.Cap_Nhat(myTmp_E2_Den_Chi_Tiet)

                    If (Id_E2 <> Id_E2_Sua) Then
                        myE2_Den.Cap_Nhat_Id_E2(Id_E2, Id_E2_Sua)
                        myTmp_E2_Den.Cap_Nhat_Id_E2(Id_E2, Id_E2_Sua)
                    End If
                    '' E1
                    myE1_Den.Cap_Nhat_Id_E1(Id_E2, Id_E2_Sua, Id_Duong_Thu, Id_Duong_Thu_Sua, Id_Chuyen_Thu, Id_Chuyen_Thu_Sua, Id_Ca, Id_Ca_Sua, Ngay_Khai_Thac, Ngay_Khai_Thac_Sua, Gio, Gio_Sua)
                    myE2_Den.Hieu_Chinh_Cap_Nhat_Them_CT(Id_E2_Sua, False)
                    myE2_Den.Xoa_Chuyen_Thu(Id_Chuyen_Thu)
                    'myTmp_E2_Den.Hieu_Chinh_Cap_Nhat_Them_CT(Id_E2_Sua, False)
                    'myTmp_E2_Den.Xoa_Chuyen_Thu(Id_Chuyen_Thu)

                    ' Hiệu chỉnh lại thông tin của chuyến thu cũ 
                    myChuyen_Thu_Di.Hieu_Chinh(Id_Chuyen_Thu, False)
                ...
                End If
            End If
        Else ' Nếu không tồn tại chuyến thư.:thay đổi thông tin về đường thư,chuyến thư túi số
            Id_Chuyen_Thu_Sua = CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Loai_Chuyen_Thu_Sua)
            Dim Str As String = "Bạn có muốn cập nhật bản kê:" & vbNewLine & dtpNgayKhaiThacCanSua.DateTime & vbNewLine & "ca kế toán: " & cbCaKeToanCanSua.Value & "theo đường thư " & cbDuongThuCanSua.Text & ", chuyến thư " & cbChuyenThuCanSua.Text & " túi số " & cbTuiSoCanSua.Text & vbNewLine & vbNewLine & dtpNgayKhaiThacSua.DateTime & vbNewLine & "ca kế toán: " & cbCaKeToanSua.Value & "theo đường thư " & cbDuongThuSua.Text & ", chuyến thư " & cbChuyenThuSua.Text & " túi số " & cbTuiSoSua.Text
            If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
                ' Cập nhật vào bảng CHuyen_Thu_Den với Id_CHuyen_Thu = Id cũ
                'myChuyen_Thu_Den_Chi_Tiet = myChuyen_Thu_Den.Lay(Id_Chuyen_Thu)
                'myChuyen_Thu_Den.Cap_Nhat(myChuyen_Thu_Den_Chi_Tiet)

                myChuyen_Thu_Den.Cap_Nhat_Them(Id_Chuyen_Thu_Sua, Id_Duong_Thu_Sua, GId_Ca, GBuu_Cuc_Khai_Thac, Chuyen_Thu_Sua, Ngay_Khai_Thac_Sua, Gio_Sua, Ngay_Nhan, Gio_Nhan, Tong_So_Tui, Tong_So_BP, Tong_KL, Tong_KLBP, Tong_Cuoc_COD, Tong_Cuoc_DV, Tong_Cuoc, HH_Phat_Hanh, HH_Phat_Tra, Convert.ToBoolean(Dong_F), Convert.ToBoolean(Truyen_Khai_Thac), Convert.ToBoolean(Truyen_Doi_Soat), Ngay_He_Thong, Convert.ToBoolean(Chot_Sl))
                ' Cập nhật vào bảng E2_Den
                myE2_Den_Chi_Tiet = myE2_Den.Lay(Id_E2)
...
#Region "BTN Sua E2 LOI"
    Private Sub btnSuaE2Loi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSuaE2Loi.Click
        ...
        Dim Id_Duong_Thu As String = myDuong_Thu_Den.Select_Id_Duong_Thu_Den(GBuu_Cuc_Khai_Thac.ToString, cbDuongThuCanSua.Text)
        'Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Lay_Id_Chuyen_Thu(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), cbChuyenThuCanSua.Value).Id_Chuyen_Thu
        Dim Id_Chuyen_Thu As String = myChuyen_Thu_Den.Chuyen_Thu_Den_Lay_Id_Chuyen_Thu_Theo_Phan_Loai_Chuyen_Thu(Id_Duong_Thu, myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.DateTime), cbChuyenThuCanSua.Value, cbPhanLoaiCanSua.Value).Id_Chuyen_Thu
        Dim Tui_So As Integer = cbTuiSoCanSua.Value
        Dim Id_E2 As String = myE2_Den.Lay_TT_E1(Id_Chuyen_Thu, Tui_So).Id_E2
...
#Region "Tổng hợp E2_Den từ E1_Den"
    Private Sub Tong_Hop_E2_Den_tu_E1_Den(ByVal Id_E2 As String)
        ...
        If myE2_Den_Chi_Tiet.Tong_So_BP > 0 Then 'Cập nhật lại thông tin trên E2 nếu tổng số BP>0
            ...
            Dim myTmp_E2_Den_Chi_Tiet As New Tmp_E2_Den_Chi_Tiet
            Dim myTmp_E2_Den As New Tmp_E2_Den(GConnectionString)
            myTmp_E2_Den_Chi_Tiet.Khoi_Luong_BP = myE2_Den_TH_E1_Den.Khoi_Luong_BP
            myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_COD = myE2_Den_TH_E1_Den.Tong_Cuoc_COD
            myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_DV = myE2_Den_TH_E1_Den.Tong_Cuoc_DV
            myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_Chinh = myE2_Den_TH_E1_Den.Tong_Cuoc_Chinh
            myTmp_E2_Den_Chi_Tiet.HH_Phat_Hanh = myE2_Den_TH_E1_Den.HH_Phat_Hanh
            myTmp_E2_Den_Chi_Tiet.HH_Phat_Tra = myE2_Den_TH_E1_Den.HH_Phat_Tra
            myTmp_E2_Den.Tmp_E2_Den_Cap_Nhat_Them_KT(myTmp_E2_Den_Chi_Tiet.Id_E2, myTmp_E2_Den_Chi_Tiet.Id_Duong_Thu, myTmp_E2_Den_Chi_Tiet.Id_Chuyen_Thu, myTmp_E2_Den_Chi_Tiet.Id_Ca, myTmp_E2_Den_Chi_Tiet.Ma_Bc_Khai_Thac, myTmp_E2_Den_Chi_Tiet.Ngay_Dong, myTmp_E2_Den_Chi_Tiet.Gio_Dong, myE2_Den_Chi_Tiet.Ngay_Nhan, myE2_Den_Chi_Tiet.Gio_Nhan, myE2_Den_Chi_Tiet.Tui_So, myE2_Den_Chi_Tiet.Tui_F, myE2_Den_Chi_Tiet.Tong_So_BP, myTmp_E2_Den_Chi_Tiet.Khoi_Luong_Vo_Tui, myTmp_E2_Den_Chi_Tiet.Khoi_Luong_BP, myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_COD, myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_DV, myTmp_E2_Den_Chi_Tiet.Tong_Cuoc_Chinh, myTmp_E2_Den_Chi_Tiet.HH_Phat_Hanh, myTmp_E2_Den_Chi_Tiet.HH_Phat_Tra, myTmp_E2_Den_Chi_Tiet.Truyen_Khai_Thac, myTmp_E2_Den_Chi_Tiet.Truyen_Doi_Soat, myTmp_E2_Den_Chi_Tiet.Chot_SL, myTmp_E2_Den_Chi_Tiet.Id_Duong_Bay)
