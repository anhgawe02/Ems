...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(FrmSuaChuaE2))
        ...
        Me.cbChuyenThuCanSua.Location = New System.Drawing.Point(112, 152)
        Me.cbChuyenThuCanSua.Name = "cbChuyenThuCanSua"
        Me.cbChuyenThuCanSua.Size = New System.Drawing.Size(104, 21)
        Me.cbChuyenThuCanSua.TabIndex = 14
        ...
        Me.Label8.Location = New System.Drawing.Point(112, 128)
        ...
        Me.cbTuiSoCanSua.Location = New System.Drawing.Point(224, 152)
        ...
        Appearance4.ImageAlpha = Infragistics.Win.Alpha.UseAlphaLevel
        ...
        Me.cbTuiSoSua.Location = New System.Drawing.Point(224, 152)
        Me.cbTuiSoSua.Name = "cbTuiSoSua"
        Me.cbTuiSoSua.Size = New System.Drawing.Size(64, 21)
        Me.cbTuiSoSua.TabIndex = 12
        ...
        Me.cbChuyenThuSua.Location = New System.Drawing.Point(112, 152)
        Me.cbChuyenThuSua.Name = "cbChuyenThuSua"
        Me.cbChuyenThuSua.Size = New System.Drawing.Size(104, 21)
        Me.cbChuyenThuSua.TabIndex = 11
        ...
        Me.Label17.Location = New System.Drawing.Point(224, 128)
        ...
        Me.Label18.Location = New System.Drawing.Point(112, 128)
...
#Region "Khai Bao"
    ...
    'Loai chuyen thu khai thac dong di default là EN
    Const myLoai_Chuyen_Thu As String = "EN"
#End Region
...
#Region "THONG TIN CAN SUA"
    ...
    Private Sub cbDuongThuCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbDuongThuCanSua.Validated
        ...
        ElseIf cbDuongThuCanSua.Text <> "" And cbDuongThuCanSua.Text.Length = 6 Then
            ...
            ElseIf Id_Phan_Loai = 1 Then  'Đường Thư Nội Tỉnh: Chuyến Thư tăng theo Tháng
                myStart_Date = (Ngay_Khai_Thac \ 100) * 100
                myEnd_Date = (Ngay_Khai_Thac \ 100) * 100 + 99
            Else : Id_Phan_Loai = 2 Or Id_Phan_Loai = 3 Or Id_Phan_Loai = 4 Or Id_Phan_Loai = 5 Or Id_Phan_Loai = 6 Or Id_Phan_Loai = 7 Or Id_Phan_Loai = 8 'Đường Thư Liên Tỉnh,Liền kề, Quốc tê: Chuyến Thư tăng theo Năm
    ...
    Private Sub ChuyenThuCanSua_DataBind()
        ...
        Else : Id_Phan_Loai = 2 Or Id_Phan_Loai = 3 Or Id_Phan_Loai = 4 Or Id_Phan_Loai = 5 Or Id_Phan_Loai = 6 Or Id_Phan_Loai = 7 Or Id_Phan_Loai = 8 'Đường Thư Liên Tỉnh,Liền kề, Quốc tê: Chuyến Thư tăng theo Năm
            ...
            myEnd_Date = (Ngay_Khai_Thac \ 10000) * 10000 + 9999
        End If
        cbChuyenThuCanSua.DataSource = myChuyen_Thu_Di.Danh_Sach_Chuyen_Thu(Id_Duong_Thu, myStart_Date, myEnd_Date)
    ...
    Private Sub cbChuyenThuCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbChuyenThuCanSua.Validated
        If cbDuongThuCanSua.Text <> "" And cbChuyenThuCanSua.Text <> "" Then
            ...
            '    myStart_Date = (Ngay_Dong \ 100) * 100
            '    myEnd_Date = (Ngay_Dong \ 100) * 100 + 99
            'Else : Id_Phan_Loai = 2 Or Id_Phan_Loai = 3 Or Id_Phan_Loai = 4 'Đường Thư Liên Tỉnh,Liền kề, Quốc tê:
            ' Chuyến Thư tăng theo Năm
    ...
    Private Sub cbTuiSoCanSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbTuiSoCanSua.Validated
        If cbTuiSoCanSua.Text <> "" And cbChuyenThuCanSua.Text <> "" And cbDuongThuCanSua.Text <> "" Then
            ...
            Dim Chk_Id_E2 As Boolean = myE2_Di.IsExist_E2_Di_Edit(Id_Chuyen_Thu, Tui_So, myStart_Date, myEnd_Date)
            ...
            txtGioKhaiThacSua.Value = Gio_Dong.ToString("0000") 'txtGioKhaiThacCanSua.Value
            txtGioKhaiThacSua.Text = Gio_Dong.ToString("0000") 'txtGioKhaiThacCanSua.Text
            '' lblCanSua
            lblCanSua.Text = ""
...
#Region "THONG TIN SUA"
    ...
    Private Sub cbChuyenThuSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbChuyenThuSua.Validated
        If cbChuyenThuSua.Text <> "" Then
            ...
            'Else : Id_Phan_Loai = 2 Or Id_Phan_Loai = 3 Or Id_Phan_Loai = 4 'Đường Thư Liên Tỉnh,Liền kề, Quốc tê: Chuyến Thư tăng theo Năm
                ...
                'End If
            ''Kiểm tra Id_Chuyen_Thu xem có tồn tại hay ko
            Dim chk_Id_Chuyen_thu As Boolean = myChuyen_Thu_Di.IsExist_Chuyen_Thu_Di(Id_Duong_Thu_Sua, cbChuyenThuSua.Text, myStart_Date, myEnd_Date)
            If chk_Id_Chuyen_thu = True Then
                Dim Id_Chuyen_Thu As String = myChuyen_Thu_Di.Lay_Id_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date, myEnd_Date, Convert.ToInt32(cbChuyenThuSua.Text)).Id_Chuyen_Thu
                '' Túi số DataBind
                cbTuiSoSua.DataSource = myE2_Di.Danh_Sach_Tui_So(Id_Chuyen_Thu)
                cbTuiSoSua.DataBind()

                Dim Tong_So_E2 As String = myChuyen_Thu_Di.Lay_Tong_E2_E1_Theo_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date, myEnd_Date, cbChuyenThuSua.Value).Tong_So_Tui
                Dim Tong_So_E1 As String = myChuyen_Thu_Di.Lay_Tong_E2_E1_Theo_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date, myEnd_Date, cbChuyenThuSua.Value).Tong_So_BP
                Dim Tong_KLBP As String = myChuyen_Thu_Di.Lay_Tong_E2_E1_Theo_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date, myEnd_Date, cbChuyenThuSua.Value).Tong_KLBP
                '' lblSua
                lblSua.Text = ""
            ...
            Else
                If MessageBox.Show("Chuyến thư này không tồn tai, có phải bạn muốn cập nhật vào chuyến thư mới không ?", "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
                End If
            End If
        End If
    End Sub
    ...
    Private Sub cbDuongThuSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbDuongThuSua.Validated
        If cbDuongThuSua.Text <> "" Then
            ...
            Dim Id_Duong_Thu_Sua As String = myDuong_Thu_Di.Select_Id_Duong_Thu_Di(GBuu_Cuc_Khai_Thac.ToString, cbDuongThuSua.Text)
    ...
    Private Sub cbTuiSoSua_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbTuiSoSua.Validated
        If cbTuiSoSua.Text <> "" And cbChuyenThuSua.Text <> "" And cbDuongThuSua.Text <> "" Then
            ...
            If chk_Id_Chuyen_thu = True Then
                ...
                '' cbCaKeToanSua
                'cbCaKeToanSua.DataSource = myCa_San_Xuat.Danh_Sach_Kt(Ngay_Dong, GBuu_Cuc_Khai_Thac).Tables(0)
                'cbCaKeToanSua.DataBind()
                'If cbCaKeToanSua.Rows.Count <> 0 Then
                'cbCaKeToanSua.Value = cbCaKeToanSua.Rows(0).Cells("Thu_Tu").Value
                'End If
...
#Region "XOA"
    Private Sub btnXoaE1E2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXoaE2.Click
        ...
        Dim Str As String = "Bạn có đồng ý xoá tờ E2:" & vbNewLine & "Ngày:" & Ham_Dung_Chung.ConvertIntToVNDateType(Ngay_Khai_Thac) & vbNewLine & "Đường thư: " & cbDuongThuCanSua.Text & vbNewLine & "Chuyến thư: " & cbChuyenThuCanSua.Text & vbNewLine & "Túi số: " & cbTuiSoCanSua.Text
        ...
        If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            'Tao chi tiet truoc
            myChi_Tiet_Truoc = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(myE2_Di_Chi_Tiet_Ghi_Log.Id_Duong_Thu, myE2_Di_Chi_Tiet_Ghi_Log.Ngay_Dong, Mdl_Event_Viewer.Get_Loai_Chuyen_Thu_From_Id_Chuyen_Thu(myE2_Di_Chi_Tiet_Ghi_Log.Id_Chuyen_Thu), cbChuyenThuCanSua.Text, cbTuiSoCanSua.Text, myE2_Di_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Di_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
            'Tao chi tiet sau
            myChi_Tiet_Sau = ""
            '==============================================================================   
...
#Region "SUA"
    Private Sub btnSua_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSua.Click
        Try
            ...
            Dim Loai_Chuyen_Thu_Can_Sua As String = myLoai_Chuyen_Thu
            ...
            Dim Loai_Chuyen_Thu_Sua As String = myLoai_Chuyen_Thu
        ...
        End Try
        'Try
        '    '==============Kiểm tra dữ liệu nhập vào đã hợp lệ chưa====================
        '    If cbDuongThuSua.Text = "" Or cbChuyenThuSua.Text = "" Or cbTuiSoSua.Text = "" Then
        '        CMessageBox.Show("Dữ liệu chữa đầy đủ, bạn hãy kiểm tra lại !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '        Exit Sub
        '    End If
        ...
        '    Dim Id_Duong_Thu As String = myDuong_Thu_Di.Select_Id_Duong_Thu_Di(GBuu_Cuc_Khai_Thac, Convert.ToInt32(cbDuongThuCanSua.Text))
        '    If Id_Duong_Thu Is Nothing Then
        '        CMessageBox.Show("Không tồn tại đường thư này bạn phại vào bảng Ðường Thư Ði để cập nhật.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information)
        '        Exit Sub
        '    End If
        '    '=============================================================================

        '    '================== Thông tin cần sửa ========================================
        '    Dim Chuyen_Thu_Can_Sua As Integer = cbChuyenThuCanSua.Text
        '    Dim Ngay_Dong_Can_Sua As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacCanSua.Value)
        '    Dim Gio As Integer = myHamdungchung.ConvertTimeToInt(txtGioKhaiThacCanSua.Value)

        '    'Chuyen Thu tang theo Nam
        '    Dim myStart_Date As Integer
        '    Dim myEnd_Date As Integer
        '    myStart_Date = (Ngay_Dong_Can_Sua \ 10000) * 10000
        '    myEnd_Date = (Ngay_Dong_Can_Sua \ 10000) * 10000 + 9999
        '    Dim Id_Chuyen_Thu As String = myChuyen_Thu_Di.Lay_Id_Chuyen_Thu(Id_Duong_Thu, myStart_Date, myEnd_Date, Chuyen_Thu_Can_Sua).Id_Chuyen_Thu
        '    Dim Tui_So As Integer = cbTuiSoCanSua.Value
        '    Dim Ca_Ke_Toan As Integer = Convert.ToInt32(cbCaKeToanCanSua.Text)
        '    Dim Ngay_Ke_Toan As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKeToan.Value)
        '    Dim Id_Ca As String = myCa_San_Xuat.Lay_Id_Ca(GBuu_Cuc_Khai_Thac, Ngay_Ke_Toan, Ca_Ke_Toan).Id_Ca
        '    '=============================================================================

        '    '''''''''''''''''''''''''''' Thông tin sửa.''''''''''''''''''''''''''''
        '    Dim Chuyen_Thu_Sua As Integer = cbChuyenThuSua.Text
        '    Dim Ngay_Dong_Sua As Integer = myHamdungchung.ConvertDateToInt(dtpNgayKhaiThacSua.Value)
        '    Dim Gio_Sua As Integer = myHamdungchung.ConvertTimeToInt(txtGioKhaiThacSua.Value)
        '    Dim Loai_Chuyen_Thu_Sua As String = "EN"
        '    Dim Id_Duong_Thu_Sua As String = myDuong_Thu_Di.Select_Id_Duong_Thu_Di(GBuu_Cuc_Khai_Thac, Convert.ToInt32(cbDuongThuSua.Text))

        '    'Chuyen Thu tang theo Nam
        '    Dim myStart_Date_Sua As Integer
        '    Dim myEnd_Date_Sua As Integer
        '    myStart_Date_Sua = (Ngay_Dong_Sua \ 10000) * 10000
        '    myEnd_Date_Sua = (Ngay_Dong_Sua \ 10000) * 10000 + 9999
        '    'Dim Id_Chuyen_Thu_Sua As String = myChuyen_Thu_Di.Lay_Id_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date_Sua, myEnd_Date_Sua, Chuyen_Thu_Sua).Id_Chuyen_Thu
        '    Dim Id_Chuyen_Thu_Sua As String = CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Dong_Sua, Loai_Chuyen_Thu_Sua)
        '    Dim Tui_So_Sua As Integer = Convert.ToInt32(cbTuiSoSua.Text)
        '    Dim Id_E2_Sua As String = CreateId_E2(Id_Chuyen_Thu_Sua, Tui_So_Sua)
        ...
        '    'Kiểm tra sự tồn tại của ca sản xuất
        ...
        '    ' Xem dã chốt số liệu hay chưa.
        '    Dim Id_E2 As String = myE2_Di.Lay_TT_E1(Id_Chuyen_Thu, Tui_So).Id_E2
        '    Dim Chot_So_Lieu As Boolean = myE2_Di.Chot_So_Lieu(Id_E2)
        ...
        '    mChuyen_Thu_Di_Chi_Tiet = myChuyen_Thu_Di.Lay(Id_Chuyen_Thu)

        '    Dim So_Chuyen_thu As Integer = mChuyen_Thu_Di_Chi_Tiet.So_Chuyen_Thu
        '    Dim Ngay_Dong As Integer = mChuyen_Thu_Di_Chi_Tiet.Ngay_Dong
        '    Dim Gio_Dong As Integer = mChuyen_Thu_Di_Chi_Tiet.Gio_Dong
        '    Dim Ngay_Nhan As Integer = mChuyen_Thu_Di_Chi_Tiet.Ngay_Nhan
        '    Dim Gio_Nhan As Integer = mChuyen_Thu_Di_Chi_Tiet.Gio_Nhan
        '    Dim Tong_So_Tui As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_So_Tui
        '    Dim Tong_So_BP As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_So_BP
        '    Dim Tong_KL As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_KL
        '    Dim Tong_KLBP As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_KLBP
        '    Dim Tong_Cuoc_COD As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_Cuoc_COD
        '    Dim Tong_Cuoc_DV As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_Cuoc_DV
        '    Dim Tong_Cuoc As Integer = mChuyen_Thu_Di_Chi_Tiet.Tong_Cuoc
        '    Dim HH_Phat_Hanh As Integer = mChuyen_Thu_Di_Chi_Tiet.HH_Phat_Hanh
        '    Dim HH_Phat_Tra As Integer = mChuyen_Thu_Di_Chi_Tiet.HH_Phat_Tra
        '    Dim Dong_F As Integer = mChuyen_Thu_Di_Chi_Tiet.Dong_F
        '    Dim Truyen_Khai_Thac As Integer = mChuyen_Thu_Di_Chi_Tiet.Truyen_Khai_Thac
        '    Dim Truyen_Doi_Soat As Integer = mChuyen_Thu_Di_Chi_Tiet.Truyen_Doi_Soat
        '    Dim Ngay_He_Thong As Integer = mChuyen_Thu_Di_Chi_Tiet.Ngay_He_Thong
        '    Dim Chot_Sl As Integer = mChuyen_Thu_Di_Chi_Tiet.Chot_Sl

        '    ' Kiểm tra sự tồn tại của chuyến thứ sửa.
        '    Dim chk_Id_Chuyen_thu As Boolean = myChuyen_Thu_Di.IsExist_Chuyen_Thu_Di(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, myStart_Date, myEnd_Date)

        '    If chk_Id_Chuyen_thu = True Then ' Nếu tồn tại chuyến thư
        '        Dim myId_chuyen_thu As String = myChuyen_Thu_Di.Lay_Id_Chuyen_Thu(Id_Duong_Thu_Sua, myStart_Date, myEnd_Date, Chuyen_Thu_Sua).Id_Chuyen_Thu

        '        ' Nếu tồn tại túi số
        '        Dim Chk_Id_E2 As Boolean = myE2_Di.IsExist_E2_Di_Edit(myId_chuyen_thu, Tui_So_Sua, myStart_Date_Sua, myEnd_Date_Sua)
        '        If Chk_Id_E2 = True Then '' Trường hợp cùng chuyến thư(sưa ngày, giờ, ca kt, ...)              
        '            Dim Str As String = "   Bạn có muốn cập nhật bản kê:" & vbNewLine & _
        '                                    "Ngày: " & dtpNgayKhaiThacCanSua.DateTime.Date & _
        '                                    " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio) & vbNewLine & _
        '                                    "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & _
        '                                    ", Ca kt: " & Ca_Ke_Toan & vbNewLine & _
        '                                    "Ðường thư: " & cbDuongThuCanSua.Text & _
        '                                    ", chuyến thu: " & cbChuyenThuCanSua.Text & _
        '                                    ", túi số: " & cbTuiSoCanSua.Text & "." & vbNewLine & vbNewLine & _
        '                                    "Ngày: " & dtpNgayKhaiThacSua.DateTime.Date & _
        '                                    " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio_Sua) & vbNewLine & _
        '                                    "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & _
        '                                    ", Ca kt:" & Ca_Ke_Toan_Sua & vbNewLine & _
        '                                    "Ðường thư: " & cbDuongThuSua.Text & _
        '                                    ", chuyến thư: " & cbChuyenThuSua.Text & _
        '                                    ", túi số: " & cbTuiSoSua.Text & "."
        '            If (Id_Duong_Thu = Id_Duong_Thu_Sua And Chuyen_Thu_Can_Sua = Chuyen_Thu_Sua And (Ngay_Dong_Can_Sua <> Ngay_Dong_Sua Or Gio <> Gio_Sua Or Ngay_Ke_Toan <> Ngay_Ke_Toan_Sua Or Ca_Ke_Toan <> Ca_Ke_Toan_Sua)) Then
        '                If MessageBox.Show(Str, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
        '                    ' Cập nhật vào bảng E2_Di
        '                    myE2_Di_Chi_Tiet = myE2_Di.Lay(Id_E2)

        '                    'Them phan Ghi Log (Chuan bi du lieu) ========================================
        '                    Dim myBo_Phan As Integer = 2  'Thiet lap di
        '                    Dim myChi_Tiet_Truoc As String   'Chi tiet truoc khi sua E2
        '                    Dim myChi_Tiet_Sau As String     'Chi tiet sau khi sua E2
        '                    Dim myE2_Di_Chi_Tiet_Ghi_Log As New E2_Di_Chi_Tiet  'Thong tin chi tiet cua E2 se sua
        '                    myE2_Di_Chi_Tiet_Ghi_Log = myE2_Di_Chi_Tiet
        '                    'Tao chi tiet truoc
        '                    myChi_Tiet_Truoc = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(myE2_Di_Chi_Tiet_Ghi_Log.Id_Duong_Thu, myE2_Di_Chi_Tiet_Ghi_Log.Ngay_Dong, Mdl_Event_Viewer.Get_Loai_Chuyen_Thu_From_Id_Chuyen_Thu(myE2_Di_Chi_Tiet_Ghi_Log.Id_Chuyen_Thu), cbChuyenThuCanSua.Text, cbTuiSoCanSua.Text, myE2_Di_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Di_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
        '                    'Tao chi tiet sau
        '                    myChi_Tiet_Sau = Mdl_Event_Viewer.Event_Viewer_Create_Chi_Tiet_E2(cbDuongThuSua.Value, Ngay_Dong_Sua, Mdl_Event_Viewer.Get_Loai_Chuyen_Thu_From_Id_Chuyen_Thu(myE2_Di_Chi_Tiet_Ghi_Log.Id_Chuyen_Thu), cbChuyenThuSua.Text, cbTuiSoSua.Text, myE2_Di_Chi_Tiet_Ghi_Log.Tong_So_BP, myE2_Di_Chi_Tiet_Ghi_Log.Khoi_Luong_BP)
        '                    '============================================================================== 

        '                    myE2_Di_Chi_Tiet.Ngay_Dong = Ngay_Dong_Sua
        '                    myE2_Di_Chi_Tiet.Gio_Dong = Gio_Sua
        '                    myE2_Di_Chi_Tiet.Id_Ca = Id_Ca_Sua
        '                    myE2_Di_Chi_Tiet.Id_Chuyen_Thu = myId_chuyen_thu
        '                    myE2_Di.Cap_Nhat(myE2_Di_Chi_Tiet)
        '                    ' Cập nhật vào bảng E1_Di
        '                    myE1_Di.Cap_Nhat_Id_E1(Id_E2, Id_E2, Id_Duong_Thu, Id_Duong_Thu, Id_Chuyen_Thu, myId_chuyen_thu, Id_Ca, Id_Ca_Sua, Ngay_Dong_Can_Sua, Ngay_Dong_Sua, Gio, Gio_Sua)
        '                    'myE2_Di.Hieu_Chinh(CreateId_E2(CreateId_Chuyen_Thu(Id_Duong_Thu_Sua, Chuyen_Thu_Sua, Ngay_Dong_Sua, Loai_Chuyen_Thu_Sua), Tui_So_Sua), True)

        '                    '=============bỏ hết phần này đi===================
        '                    'myE2_Di.Hieu_Chinh_Cap_Nhat_Them_CT(Id_E2, True)
        '                    'myE2_Di.Xoa_Chuyen_Thu(Id_Chuyen_Thu)
        ...
        '                Exit Sub
        '            End If
        '        Else 'Nếu thay đổi thông tin về túi số,ngày,giưof,ca khai thác
        '            Dim Str As String = "   Bạn có muốn cập nhập bản kê:" & vbNewLine & _
        '                                "Ngày: " & dtpNgayKhaiThacCanSua.DateTime.Date & _
        '                                " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio) & vbNewLine & _
        '                                "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & _
        '                                ", Ca kt: " & Ca_Ke_Toan & vbNewLine & _
        '                                "Ðường thư: " & cbDuongThuCanSua.Text & _
        '                                ", chuyến thư: " & cbChuyenThuCanSua.Text & _
        '                                ", túi số: " & cbTuiSoCanSua.Text & "." & vbNewLine & vbNewLine & _
        '                                "Ngày: " & dtpNgayKhaiThacSua.DateTime.Date & vbNewLine & _
        '                                "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & _
        '                                ", Ca kt:" & Ca_Ke_Toan_Sua & vbNewLine & _
        '                                "Ðường thư: " & cbDuongThuSua.Text & _
        '                                ", chuyến thư: " & cbChuyenThuSua.Text & _
        ...
        '                myE2_Di_Chi_Tiet.Id_Duong_Thu = Id_Duong_Thu_Sua
        '                myE2_Di_Chi_Tiet.Ngay_Dong = Ngay_Dong_Sua
        '                myE2_Di_Chi_Tiet.Gio_Dong = Gio_Sua
        '                myE2_Di_Chi_Tiet.Tui_So = Tui_So_Sua
        '                myE2_Di_Chi_Tiet.Id_Ca = Id_Ca_Sua
        '                myE2_Di_Chi_Tiet.Id_Chuyen_Thu = myId_chuyen_thu
        '                myE2_Di.Cap_Nhat(myE2_Di_Chi_Tiet)
        '                myE2_Di.Cap_Nhat_Id_E2(Id_E2, Id_E2_Sua)
        '                ' Cập nhật vào bảng E1.
        '                myE1_Di.Cap_Nhat_Id_E1(Id_E2, Id_E2_Sua, Id_Duong_Thu, Id_Duong_Thu_Sua, Id_Chuyen_Thu, myId_chuyen_thu, Id_Ca, Id_Ca_Sua, Ngay_Dong_Can_Sua, Ngay_Dong_Sua, Gio, Gio_Sua)
        '                myE2_Di.Hieu_Chinh_Cap_Nhat_Them_CT(Id_E2_Sua, True)
        '                'myE2_Di.Xoa_Chuyen_Thu(Id_Chuyen_Thu)
        '                ' Hiệu chỉnh lại thông tin của chuyến thu cũ 
        '                myChuyen_Thu_Di.Hieu_Chinh(Id_Chuyen_Thu, True)
        ...
        '            End If
        '        End If
        '    Else ' Nếu thêm mới chuyển thư
        '        Dim Str_add_chuyenthu As String = "   Bạn có muốn cập nhật bản kê:" & vbNewLine & _
        '                                "Ngày: " & dtpNgayKhaiThacCanSua.DateTime.Date & _
        '                                " Giờ: " & Ham_Dung_Chung.ConvertIntToTime(Gio) & vbNewLine & _
        '                                "Ngày kt: " & dtpNgayKeToanSua.DateTime.Date & ", Ca kt: " & Ca_Ke_Toan & vbNewLine & _
        '                                "Ðường thư: " & cbDuongThuCanSua.Text & _
        '                                ", chuyến thư: " & cbChuyenThuCanSua.Text & _
        '                                ", túi số: " & cbTuiSoCanSua.Text & "." & vbNewLine & vbNewLine & _
        '                                "Ngày: " & dtpNgayKhaiThacSua.DateTime.Date & _
        ...
        '                                ", chuyến thư: " & cbChuyenThuSua.Text & _
        '                                ", túi số: " & cbTuiSoSua.Text & "."
        '        If MessageBox.Show(Str_add_chuyenthu, "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) = DialogResult.Yes Then
        '            ' Cập nhật vào bảng Chuyen_Thu_Di 
        '            myChuyen_Thu_Di.Cap_Nhat_Them(Id_Chuyen_Thu_Sua, Id_Duong_Thu_Sua, GId_Ca, GBuu_Cuc_Khai_Thac, Chuyen_Thu_Sua, Ngay_Dong_Sua, Gio_Sua, Ngay_Nhan, Gio_Nhan, Tong_So_Tui, Tong_So_BP, Tong_KL, Tong_KLBP, Tong_Cuoc_COD, Tong_Cuoc_DV, Tong_Cuoc, HH_Phat_Hanh, HH_Phat_Tra, Convert.ToBoolean(Dong_F), Convert.ToBoolean(Truyen_Khai_Thac), Convert.ToBoolean(Truyen_Doi_Soat), Ngay_He_Thong, Convert.ToBoolean(Chot_Sl))
        '            ' Cập nhật vào bảng E2_Di
        '            myE2_Di_Chi_Tiet = myE2_Di.Lay(Id_E2)
        ...
        '            myE2_Di_Chi_Tiet.Tui_So = Tui_So_Sua
        '            myE2_Di_Chi_Tiet.Id_Ca = Id_Ca_Sua
        '            myE2_Di_Chi_Tiet.Id_Chuyen_Thu = Id_Chuyen_Thu_Sua
        '            myE2_Di.Cap_Nhat(myE2_Di_Chi_Tiet)
        '            If (Id_E2 <> Id_E2_Sua) Then
        '                myE2_Di.Cap_Nhat_Id_E2(Id_E2, Id_E2_Sua)
        '            End If
        '            ' Cập nhật vào bảng E1_Di
        '            myE1_Di.Cap_Nhat_Id_E1(Id_E2, Id_E2_Sua, Id_Duong_Thu, Id_Duong_Thu_Sua, Id_Chuyen_Thu, Id_Chuyen_Thu_Sua, Id_Ca, Id_Ca_Sua, Ngay_Dong_Can_Sua, Ngay_Dong_Sua, Gio, Gio_Sua)
        '            myE2_Di.Hieu_Chinh_Cap_Nhat_Them_CT(Id_E2_Sua, True)
        '            'myE2_Di.Xoa_Chuyen_Thu(Id_Chuyen_Thu)
        '            ' Hiệu chỉnh lại thông tin của chuyến thu cũ 
        '            myChuyen_Thu_Di.Hieu_Chinh(Id_Chuyen_Thu, True)
        ...
        '    End If
        'Catch ex As Exception
        '    CMessageBox.Show("Bạn cần kiểm tra lại các thông tin nhâp")
        '    Exit Sub
        'End Try
    End Sub
#End Region
...
#Region "BTN Sua E2 Loi"
    Private Sub btnSuaE2Loi_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSuaE2Loi.Click
        ...
        If Chk = True Then 'Nếu bản kê bị lỗi: tổng số = 0
            ...
            End If
        Else
            'Kiểm tra thông tin trong bảng E1
            'Id_E2 = CreateId_E2(Id_Duong_Thu, cbChuyenThuCanSua.Value, Tui_So, Ngay_Khai_Thac, "EN")
            'Dim myE1_Di As New E1_Di(GConnectionString)
            'Dim myDataSet As New DataSet
            'myDataSet = myE1_Di.E1_Di_Lay_Boi_E2_Di(Id_E2)
            'If myDataSet.Tables(0).Rows.Count > 0 Then

            'Else

            'End If
            'Nếu có thông tin về E1 thì cho phép sửa lỗi
            'Tạo lại chuyến thư
            'Tạo lại E2
