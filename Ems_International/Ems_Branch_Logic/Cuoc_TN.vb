...
#Region "Lay"
        ...
        Public Function Lay(ByVal Id_Cuoc_TN As Integer) As Cuoc_TN_Chi_Tiet
            Try
...
myConnection.Dispose()
                Dim myCuoc_TN_Chi_Tiet As Cuoc_TN_Chi_Tiet = New Cuoc_TN_Chi_Tiet
...
#Region "Cap_Nhat"
        ...
        ' Output: 
        Public Sub Cap_Nhat(ByVal myCuoc_TN_Chi_Tiet As Cuoc_TN_Chi_Tiet)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Cuoc_TN_Cap_Nhat", myConnection)
