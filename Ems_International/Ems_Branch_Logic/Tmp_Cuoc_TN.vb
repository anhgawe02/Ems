...
Namespace EMS
#Region "Tmp_Cuoc_TN_Chi_Tiet"
    '*******************************************************
    ' Mỗi thuộc tính của lớp Tmp_Cuoc_TN_Chi_Tiet
    ' tương ứng với mộ trường của bảng Tmp_Cuoc_TN trong cơ sở dữ liệu
    '
    '*******************************************************
    Public Class Tmp_Cuoc_TN_Chi_Tiet
...
#Region "Lay"
        ...
        ' Nội dung: Lấy thông tin từ bảng Tmp_Cuoc_TN
        ' Input: Id_Cuoc_TN
        ' Output: Tmp_Cuoc_TN_Chi_Tiet
        Public Function Lay(ByVal Id_Cuoc_TN As Integer) As Tmp_Cuoc_TN_Chi_Tiet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Lay", myConnection)
                ...
                myConnection.Close()
                Dim myTmp_Cuoc_TN_Chi_Tiet As Tmp_Cuoc_TN_Chi_Tiet = New Tmp_Cuoc_TN_Chi_Tiet
                myTmp_Cuoc_TN_Chi_Tiet.Id_Cuoc_TN = Id_Cuoc_TN
                myTmp_Cuoc_TN_Chi_Tiet.Khu_Vuc = pKhu_Vuc.Value
                myTmp_Cuoc_TN_Chi_Tiet.Phan_Loai_BP = pPhan_Loai_BP.Value
                myTmp_Cuoc_TN_Chi_Tiet.Cach_Tinh = pCach_Tinh.Value
                myTmp_Cuoc_TN_Chi_Tiet.Khoi_Luong = pKhoi_Luong.Value
                myTmp_Cuoc_TN_Chi_Tiet.Cuoc = pCuoc.Value
                myTmp_Cuoc_TN_Chi_Tiet.Tu_Ngay = pTu_Ngay.Value
                myTmp_Cuoc_TN_Chi_Tiet.Den_Ngay = pDen_Ngay.Value
                Return myTmp_Cuoc_TN_Chi_Tiet
...
#Region "Them"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Thêm dữ liệu vào bảng Tmp_Cuoc_TN
        ...
        Public Sub Them(ByVal Khu_Vuc As Integer, ByVal Phan_Loai_BP As String, ByVal Cach_Tinh As Boolean, ByVal Khoi_Luong As Integer, ByVal Cuoc As Integer, ByVal Tu_Ngay As Integer, ByVal Den_Ngay As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Them", myConnection)
...
#Region "Cap_Nhat"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Cập nhật dữ liệu vào bảng Tmp_Cuoc_TN
        ...
        Public Sub Cap_Nhat(ByVal Id_Cuoc_TN As Integer, ByVal Khu_Vuc As Integer, ByVal Phan_Loai_BP As String, ByVal Cach_Tinh As Boolean, ByVal Khoi_Luong As Integer, ByVal Cuoc As Integer, ByVal Tu_Ngay As Integer, ByVal Den_Ngay As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Cap_Nhat", myConnection)
...
#Region "Cap_Nhat"
        ...
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Cập nhật dữ liệu vào bảng Tmp_Cuoc_TN
        ' Input: đối tượng thuộc lớp Tmp_Cuoc_TN_Chi_Tiet
        ' Output: 
        Public Sub Cap_Nhat(ByVal myTmp_Cuoc_TN_Chi_Tiet As Tmp_Cuoc_TN_Chi_Tiet)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Cap_Nhat", myConnection)
                ...
                ' Thêm các Parameters vào thủ tục						
                Dim pId_Cuoc_TN As SqlParameter = New SqlParameter("@Id_Cuoc_TN", SqlDbType.Int, 4)
                pId_Cuoc_TN.Value = myTmp_Cuoc_TN_Chi_Tiet.Id_Cuoc_TN
                myCommand.Parameters.Add(pId_Cuoc_TN)

                Dim pKhu_Vuc As SqlParameter = New SqlParameter("@Khu_Vuc", SqlDbType.Int, 4)
                pKhu_Vuc.Value = myTmp_Cuoc_TN_Chi_Tiet.Khu_Vuc
                myCommand.Parameters.Add(pKhu_Vuc)

                Dim pPhan_Loai_BP As SqlParameter = New SqlParameter("@Phan_Loai_BP", SqlDbType.VarChar, 1)
                pPhan_Loai_BP.Value = myTmp_Cuoc_TN_Chi_Tiet.Phan_Loai_BP
                myCommand.Parameters.Add(pPhan_Loai_BP)

                Dim pCach_Tinh As SqlParameter = New SqlParameter("@Cach_Tinh", SqlDbType.Bit, 1)
                pCach_Tinh.Value = myTmp_Cuoc_TN_Chi_Tiet.Cach_Tinh
                myCommand.Parameters.Add(pCach_Tinh)

                Dim pKhoi_Luong As SqlParameter = New SqlParameter("@Khoi_Luong", SqlDbType.Int, 4)
                pKhoi_Luong.Value = myTmp_Cuoc_TN_Chi_Tiet.Khoi_Luong
                myCommand.Parameters.Add(pKhoi_Luong)

                Dim pCuoc As SqlParameter = New SqlParameter("@Cuoc", SqlDbType.Int, 4)
                pCuoc.Value = myTmp_Cuoc_TN_Chi_Tiet.Cuoc
                myCommand.Parameters.Add(pCuoc)

                Dim pTu_Ngay As SqlParameter = New SqlParameter("@Tu_Ngay", SqlDbType.Int, 4)
                pTu_Ngay.Value = myTmp_Cuoc_TN_Chi_Tiet.Tu_Ngay
                myCommand.Parameters.Add(pTu_Ngay)

                Dim pDen_Ngay As SqlParameter = New SqlParameter("@Den_Ngay", SqlDbType.Int, 4)
                pDen_Ngay.Value = myTmp_Cuoc_TN_Chi_Tiet.Den_Ngay
                myCommand.Parameters.Add(pDen_Ngay)
...
#Region "Cap_Nhat_Them"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Cập nhật hoặc Thêm mới dữ liệu vào bảng Tmp_Cuoc_TN
        ' Input: Id_Cuoc_TN,  Khu_Vuc , Phan_Loai_BP , Cach_Tinh , Khoi_Luong , Cuoc , Tu_Ngay , Den_Ngay ,
        ' Output: 
        Public Sub Cap_Nhat_Them(ByVal Id_Cuoc_TN As Integer, ByVal Khu_Vuc As Integer, ByVal Phan_Loai_BP As String, ByVal Cach_Tinh As Boolean, ByVal Khoi_Luong As Integer, ByVal Cuoc As Integer, ByVal Tu_Ngay As Integer, ByVal Den_Ngay As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Cap_Nhat_Them", myConnection)
...
#Region "Xoa"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Xóa dữ liệu từ bảng Tmp_Cuoc_TN
        ' Input: Id_Cuoc_TN
        ' Output: 
        Public Sub Xoa(ByVal Id_Cuoc_TN As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Xoa", myConnection)
...
#Region "Danh_Sach"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Lấy toàn bộ dữ liệu từ bảng Tmp_Cuoc_TN
        ' Input: 
        ...
        Public Function Danh_Sach() As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Danh_Sach", myConnection)
                ...
                myAdapter.Fill(myDataSet, "Tmp_Cuoc_TN_Danh_Sach")
                myConnection.Close()
                Return myDataSet
            Catch ex As Exception
                Console.Write(ex.toString)
...
#Region "Danh_Sach_Hien_Thi"
        ...
        Public Function Danh_Sach_Hien_Thi() As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Danh_Sach_Hien_Thi", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "Tmp_Cuoc_TN_Danh_Sach_Hien_Thi")
                myConnection.Close()
                Return myDataSet
            Catch ex As Exception
                Console.Write(ex.ToString)
...
#Region "Lay_Boi_Khu_Vuc"
        ...
        Public Function Lay_Boi_Khu_Vuc(ByVal Khu_Vuc As Integer) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("Tmp_Cuoc_TN_Lay_Boi_Khu_Vuc", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "Tmp_Cuoc_TN_Lay_Boi_Khu_Vuc")
                myConnection.Close()
                Return myDataSet
            Catch ex As Exception
                Console.Write(ex.ToString)
