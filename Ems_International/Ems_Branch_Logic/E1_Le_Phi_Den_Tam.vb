...
Imports System.Math
Namespace EMS
#Region "E1_Le_Phi_Den_Tam_Chi_Tiet"
    '*******************************************************
    ' Mỗi thuộc tính của lớp E1_Le_Phi_Den_Tam_Chi_Tiet
    ' tương ứng với một trường của bảng E1_Le_Phi_Den_Tam trong cơ sở dữ liệu
    '
    '*******************************************************
    Public Class E1_Le_Phi_Den_Tam_Chi_Tiet
    ...
    End Class
#End Region
#Region "E1_Le_Phi_Den_Tam"
    Public Class E1_Le_Phi_Den_Tam
...
#Region "Lay"
        Public Function Lay(ByVal Id_E1 As String) As E1_Le_Phi_Den_Tam_Chi_Tiet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Le_Phi_Den_Tam_Lay", myConnection)
                ...
                Dim myE1_Le_Phi_Den_Tam_Chi_Tiet As E1_Le_Phi_Den_Tam_Chi_Tiet = New E1_Le_Phi_Den_Tam_Chi_Tiet
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_E1 = Id_E1
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_Duong_Thu = pId_Duong_Thu.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_Chuyen_Thu = pId_Chuyen_Thu.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_E2 = pId_E2.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_Ca = pId_Ca.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_Bc_Khai_Thac = pMa_Bc_Khai_Thac.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_E1 = pMa_E1.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ngay_Dong = pNgay_Dong.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Gio_Dong = pGio_Dong.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_Don_Vi = pMa_Don_Vi.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_Bc_Goc = pMa_Bc_Goc.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_Bc_Tra = pMa_Bc_Tra.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Nuoc_Nhan = pNuoc_Nhan.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Nuoc_Tra = pNuoc_Tra.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Khoi_Luong = pKhoi_Luong.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_HQ = pLe_Phi_HQ.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Thue_NK = pThue_NK.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Thue_VAT = pThue_VAT.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Thue_NK_VAT = pThue_NK_VAT.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.So_TKHQ = pSo_TKHQ.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.So_Bien_Lai = pSo_Bien_Lai.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Kien_So = pKien_So.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.STT = pSTT.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Id_Nguoi_Dung = pId_Nguoi_Dung.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Truyen_Khai_Thac = pTruyen_Khai_Thac.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Truyen_Doi_Soat = pTruyen_Doi_Soat.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Ngay_He_Thong = pNgay_He_Thong.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Chot_SL = pChot_SL.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_VH = pLe_Phi_VH.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_YT = pLe_Phi_YT.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_DV = pLe_Phi_DV.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_TV = pLe_Phi_TV.Value
                myE1_Le_Phi_Den_Tam_Chi_Tiet.Le_Phi_Khac = pLe_Phi_Khac.Value
                'myE1_Le_Phi_Den_Tam_Chi_Tiet.Ma_Tinh_Tra = pMa_Tinh_Tra.Value
                'myE1_Le_Phi_Den_Tam_Chi_Tiet.Phan_Loai_Duong_Thu = pPhan_Loai_Duong_Thu.Value
                Return myE1_Le_Phi_Den_Tam_Chi_Tiet
        ...
        End Function
#End Region
#Region "E1_Le_Phi_Den_Tam_Cap_Nhat"
        Public Function E1_Le_Phi_Den_Tam_Cap_Nhat(ByVal id_E1 As String, ByVal id_Duong_Thu As String, ByVal id_Chuyen_Thu As String, ByVal id_E2 As String, ByVal id_Ca As String, ByVal ma_Bc_Khai_Thac As Integer, ByVal ma_E1 As String, ByVal ngay_Dong As Integer, ByVal gio_Dong As Integer, ByVal ma_Don_Vi As String, ByVal ma_Bc_Goc As Integer, ByVal ma_Bc_Tra As Integer, ByVal nuoc_Nhan As String, ByVal nuoc_Tra As String, ByVal khoi_Luong As Integer, ByVal so_TKHQ As String, ByVal so_Bien_Lai As String, ByVal le_Phi_HQ As Integer, ByVal thue_NK As Integer, ByVal thue_VAT As Integer, ByVal thue_NK_VAT As Integer, ByVal kien_So As Integer, ByVal stt As Integer, ByVal id_Nguoi_Dung As Integer, ByVal truyen_Khai_Thac As Boolean, ByVal truyen_Doi_Soat As Boolean, ByVal ngay_He_Thong As Integer, ByVal chot_SL As Boolean, ByVal Le_Phi_VH As Integer, ByVal Le_Phi_YT As Integer, ByVal Le_Phi_DV As Integer, ByVal Le_Phi_TV As Integer, ByVal Le_Phi_Khac As Integer) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Cap_Nhat"
            MyCommand.CommandType = CommandType.StoredProcedure
...
#End Region
#Region "E1_Le_Phi_Den_Tam_Cap_Nhat_Them"
        Public Function E1_Le_Phi_Den_Tam_Cap_Nhat_Them(ByVal id_E1 As String, ByVal id_Duong_Thu As String, ByVal id_Chuyen_Thu As String, ByVal id_E2 As String, ByVal id_Ca As String, ByVal ma_Bc_Khai_Thac As Integer, ByVal ma_E1 As String, ByVal ngay_Dong As Integer, ByVal gio_Dong As Integer, ByVal ma_Don_Vi As String, ByVal ma_Bc_Goc As Integer, ByVal ma_Bc_Tra As Integer, ByVal nuoc_Nhan As String, ByVal nuoc_Tra As String, ByVal khoi_Luong As Integer, ByVal so_TKHQ As String, ByVal so_Bien_Lai As String, ByVal le_Phi_HQ As Integer, ByVal thue_NK As Integer, ByVal thue_VAT As Integer, ByVal thue_NK_VAT As Integer, ByVal kien_So As Integer, ByVal stt As Integer, ByVal id_Nguoi_Dung As Integer, ByVal truyen_Khai_Thac As Boolean, ByVal truyen_Doi_Soat As Boolean, ByVal ngay_He_Thong As Integer, ByVal chot_SL As Boolean, ByVal Le_Phi_VH As Integer, ByVal Le_Phi_YT As Integer, ByVal Le_Phi_DV As Integer, ByVal Le_Phi_TV As Integer, ByVal Le_Phi_Khac As Integer) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Cap_Nhat_Them"
            MyCommand.CommandType = CommandType.StoredProcedure
            Dim MyConnection As New SqlConnection(ConnectionString)
            MyCommand.Connection = MyConnection
...
#End Region
#Region "E1_Le_Phi_Den_Tam_Danh_Sach"

        Public Function E1_Le_Phi_Den_Tam_Danh_Sach() As DataSet
            ...
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Danh_Sach"
            MyCommand.CommandType = CommandType.StoredProcedure
        ...
        End Function
#End Region
#Region "E1_Le_Phi_Den_Tam_Them"
        Public Function E1_Le_Phi_Den_Tam_Them(ByVal id_E1 As String, ByVal id_Duong_Thu As String, ByVal id_Chuyen_Thu As String, ByVal id_E2 As String, ByVal id_Ca As String, ByVal ma_Bc_Khai_Thac As Integer, ByVal ma_E1 As String, ByVal ngay_Dong As Integer, ByVal gio_Dong As Integer, ByVal ma_Don_Vi As String, ByVal ma_Bc_Goc As Integer, ByVal ma_Bc_Tra As Integer, ByVal nuoc_Nhan As String, ByVal nuoc_Tra As String, ByVal khoi_Luong As Integer, ByVal so_TKHQ As String, ByVal so_Bien_Lai As String, ByVal le_Phi_HQ As Integer, ByVal thue_NK As Integer, ByVal thue_VAT As Integer, ByVal thue_NK_VAT As Integer, ByVal kien_So As Integer, ByVal stt As Integer, ByVal id_Nguoi_Dung As Integer, ByVal truyen_Khai_Thac As Boolean, ByVal truyen_Doi_Soat As Boolean, ByVal ngay_He_Thong As Integer, ByVal chot_SL As Boolean, ByVal Le_Phi_VH As Integer, ByVal Le_Phi_YT As Integer, ByVal Le_Phi_DV As Integer, ByVal Le_Phi_TV As Integer, ByVal Le_Phi_Khac As Integer) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Them"
            MyCommand.CommandType = CommandType.StoredProcedure
            Dim MyConnection As New SqlConnection(ConnectionString)
            MyCommand.Connection = MyConnection
...
#End Region
#Region "E1_Le_Phi_Den_Tam_Xoa"
        Public Function E1_Le_Phi_Den_Tam_Xoa(ByVal id_E1 As String) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Xoa"
            MyCommand.CommandType = CommandType.StoredProcedure
            Dim MyConnection As New SqlConnection(ConnectionString)
            MyCommand.Connection = MyConnection
...
#Region "Khai Thác"
#Region "E1_Le_Phi_Den_Tam_Cap_Nhat_Them_KT"
        Public Function E1_Le_Phi_Den_Tam_Cap_Nhat_Them_KT(ByVal id_E1 As String, ByVal id_Duong_Thu As String, ByVal id_Chuyen_Thu As String, ByVal id_E2 As String, ByVal id_Ca As String, ByVal ma_Bc_Khai_Thac As Integer, ByVal ma_E1 As String, ByVal ngay_Dong As Integer, ByVal gio_Dong As Integer, ByVal ma_Don_Vi As String, ByVal ma_Bc_Goc As Integer, ByVal ma_Bc_Tra As Integer, ByVal nuoc_Nhan As String, ByVal nuoc_Tra As String, ByVal khoi_Luong As Integer, ByVal so_TKHQ As String, ByVal so_Bien_Lai As String, ByVal le_Phi_HQ As Integer, ByVal thue_NK As Integer, ByVal thue_VAT As Integer, ByVal thue_NK_VAT As Integer, ByVal kien_So As Integer, ByVal stt As Integer, ByVal id_Nguoi_Dung As Integer, ByVal truyen_Khai_Thac As Boolean, ByVal truyen_Doi_Soat As Boolean, ByVal chot_SL As Boolean, ByVal Le_Phi_VH As Integer, ByVal Le_Phi_YT As Integer, ByVal Le_Phi_DV As Integer, ByVal Le_Phi_TV As Integer, ByVal Le_Phi_Khac As Integer) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "E1_Le_Phi_Den_Tam_Cap_Nhat_Them_KT"
            MyCommand.CommandType = CommandType.StoredProcedure
            Dim MyConnection As New SqlConnection(ConnectionString)
            MyCommand.Connection = MyConnection
