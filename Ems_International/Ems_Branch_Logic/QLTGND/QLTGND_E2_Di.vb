...
Namespace EMS
#Region "QLTGND_E2_Di_Chi_Tiet"
    '***********************************************************
    'Moi thuoc tinh thuoc lop QLTGND_E2_Di_Chi_Tiet
    'Tuong ung voi moi truong trong bang QLTGND_E2_Di trong co so du lieu
    '***********************************************************
    Public Class QLTGND_E2_Di_Chi_Tiet
...
#Region "QLTGND_E2_Di"
    Public Class QLTGND_E2_Di
        Private ConnectionString As String
        Public Sub New(ByVal _ConnectionString As String)
            ConnectionString = _ConnectionString
        End Sub

#Region "QLTGND_E2_Di_Cap_Nhat_Them"
        Public Function QLTGND_E2_Di_Cap_Nhat_Them(ByVal Id_E2 As String, ByVal Id_Giao_Nhan As String, ByVal Id_Tui_Thu As String, ByVal STT As Integer, ByVal Truyen_Khai_Thac As Boolean, ByVal Truyen_Doi_Soat As Boolean, ByVal Chot_SL As Boolean, ByVal Ngay_He_Thong As Integer, ByVal Gio_He_Thong As Integer) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Cap_Nhat_Them"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
            Dim myQLTGND_E2_Di_Chi_Tiet As New QLTGND_E2_Di_Chi_Tiet
...
#End Region
#Region "QLTGND_E2_Di_Danh_Sach"

        Public Function QLTGND_E2_Di_Danh_Sach() As DataSet
            ...
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Danh_Sach"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
        ...
        End Function
#End Region
#Region "QLTGND_E2_Di_Lay"
        Public Function QLTGND_E2_Di_Lay(ByVal Id_E2 As String) As QLTGND_E2_Di_Chi_Tiet
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Lay"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
            Dim myQLTGND_E2_Di_Chi_Tiet As New QLTGND_E2_Di_Chi_Tiet
            ...
            Try
                ...
                numRows = MyCommand.ExecuteNonQuery()
                'Get output values
                myQLTGND_E2_Di_Chi_Tiet.Id_E2 = Id_E2
                myQLTGND_E2_Di_Chi_Tiet.Id_Giao_Nhan = pId_Giao_Nhan.Value
                myQLTGND_E2_Di_Chi_Tiet.Id_Tui_Thu = pId_Tui_Thu.Value
                myQLTGND_E2_Di_Chi_Tiet.STT = pSTT.Value
                myQLTGND_E2_Di_Chi_Tiet.Truyen_Khai_Thac = pTruyen_Khai_Thac.Value
                myQLTGND_E2_Di_Chi_Tiet.Truyen_Doi_Soat = pTruyen_Doi_Soat.Value
                myQLTGND_E2_Di_Chi_Tiet.Chot_SL = pChot_SL.Value
                myQLTGND_E2_Di_Chi_Tiet.Ngay_He_Thong = pNgay_He_Thong.Value
                myQLTGND_E2_Di_Chi_Tiet.Gio_He_Thong = pGio_He_Thong.Value

                Return myQLTGND_E2_Di_Chi_Tiet
                'Return myQLTGND_E2_Di_Chi_Tiet
...
#End Region
#Region "QLTGND_E2_Di_Xoa"
        Public Function QLTGND_E2_Di_Xoa(ByVal Id_E2 As String) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Xoa"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
            Dim myQLTGND_E2_Di_Chi_Tiet As New QLTGND_E2_Di_Chi_Tiet
...
#Region "QLTGND_E2_Di_Lay_Id_E2_Theo_Ma_Vach_Tui"
        Public Function QLTGND_E2_Di_Lay_Id_E2_Theo_Ma_Vach_Tui(ByVal Id_Tui_Thu As String, ByRef So_Dong As Integer) As String
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Lay_Id_E2_Theo_Ma_Vach_Tui"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
...
#End Region
#Region "QLTGND_E2_Di_Lay_Tong_Khoi_Luong_QD_Tu_E1_Di"
        Public Function QLTGND_E2_Di_Lay_Tong_Khoi_Luong_QD_Tu_E1_Di(ByVal Id_E2 As String) As Integer
            Dim MyCommand As SqlCommand = New SqlCommand
            MyCommand.CommandText = "QLTGND_E2_Di_Lay_Tong_Khoi_Luong_QD_Tu_E1_Di"
            MyCommand.CommandType = CommandType.StoredProcedure
            MyCommand.CommandTimeout = 20000
...
#Region "QLTGND_E2_Di_Cap_Nhat_Trang_Thai_Da_In_Nhan_E4_Vao_Truyen_Doi_Soat"
        Public Sub QLTGND_E2_Di_Cap_Nhat_Trang_Thai_Da_In_Nhan_E4_Vao_Truyen_Doi_Soat(ByVal Id_E2 As String)
            Dim MyConnection As New SqlConnection(ConnectionString)
            Try
                Dim strSQL As String
                strSQL = "Update QLTGND_E2_Di set Truyen_Doi_Soat = 1 Where Id_E2 = '" & Id_E2 & "'"
