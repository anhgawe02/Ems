...
#Region "Ems_Shipping_E1_Den_Tam"
    Public Class Ems_Shipping_E1_Den_Tam
...
#Region "Lay"
        ...
        Public Function Lay(ByVal Id_E1 As String) As Ems_Shipping_E1_Den_Tam_Chi_Tiet
            Try
                ...
                Dim pId_Duong_Thu As SqlParameter = New SqlParameter("@Id_Duong_Thu", SqlDbType.VarChar, 12)
                ...
                Dim myE1_Den_Tam_Chi_Tiet As Ems_Shipping_E1_Den_Tam_Chi_Tiet = New Ems_Shipping_E1_Den_Tam_Chi_Tiet
...
#Region "Cap_Nhat_Id_E1"
        ...
        Public Sub Cap_Nhat_Id_E1(ByVal Id_E2 As String, ByVal Id_E2_Sua As String, ByVal Id_Duong_Thu As String, ByVal Id_Duong_Thu_Sua As String, ByVal Id_Chuyen_Thu As String, ByVal Id_Chuyen_Thu_Sua As String, ByVal Id_Ca As String, ByVal Id_Ca_Sua As String, ByVal Ngay_Khai_Thac As Integer, ByVal Ngay_Khai_Thac_Sua As Integer, ByVal Gio As Integer, ByVal Gio_Sua As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Cap_Nhat_Id_E1", myConnection)
                ...
                Dim pId_Duong_Thu_Sua As SqlParameter = New SqlParameter("@Id_Duong_Thu_Sua", SqlDbType.VarChar, 12)
...
#Region "Don_Du_Lieu"
        ...
        ' Input: Id_E1
        ' Output: 
        Public Sub Don_Du_Lieu(ByVal Ma_Bc_Khai_Thac As Integer, ByVal Tu_Ngay As Integer, ByVal Den_Ngay As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Don_Du_Lieu", myConnection)
...
#Region "Danh_Sach"
        ...
        End Function
#End Region
#Region "E1_Theo_Id_E1_Id_Ca"
        Public Function E1_Theo_Id_E1_Id_Ca(ByVal Id_E1 As String, ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_E1_Theo_Id_E1_Id_Ca", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ' Sử dụng Store Procedure
                myCommand.CommandType = CommandType.StoredProcedure
                'Parameter         
                Dim pId_E1 As SqlParameter = New SqlParameter("@Id_E1", SqlDbType.VarChar, 13)
                pId_E1.Value = Id_E1
                myCommand.Parameters.Add(pId_E1)
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_E1_Theo_Id_E1_Id_Ca")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
        ...
        End Function
#End Region
#Region "E1_Theo_Id_E1_Id_Ca_Dung_Trong_Chuc_Nang_Thay_The_Ma_CP"
        Public Function E1_Theo_Id_E1_Id_Ca_Dung_Trong_Chuc_Nang_Thay_The_Ma_CP(ByVal Id_E1 As String, ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_E1_Theo_Id_E1_Id_Ca_Dung_Trong_Chuc_Nang_Thay_The_Ma_CP", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ' Sử dụng Store Procedure
                myCommand.CommandType = CommandType.StoredProcedure
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_E1_Theo_Id_E1_Id_Ca_Dung_Trong_Chuc_Nang_Thay_The_Ma_CP")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
...
#End Region
#Region "Danh_Sach_E1"
        Public Function Danh_Sach_E1_Lay_Boi_Id_E2(ByVal Id_E2 As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Danh_Sach_E1_Lay_Boi_Id_E2", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ' Sử dụng Store Procedure
                myCommand.CommandType = CommandType.StoredProcedure
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Danh_Sach_E1_Lay_Boi_Id_E2")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
...
#Region "Danh_Sach_E1_Truyen"
        ...
        Public Function Danh_Sach_E1_Truyen(ByVal Id_Chuyen_Thu As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Danh_Sach_E1_Lay_Boi_Id_Chuyen_Thu_Truyen", myConnection)
                ...
                Dim pId_Chuyen_Thu As SqlParameter = New SqlParameter("@Id_Chuyen_Thu", SqlDbType.VarChar, 24)
                pId_Chuyen_Thu.Value = Id_Chuyen_Thu
                myCommand.Parameters.Add(pId_Chuyen_Thu)

                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Danh_Sach_E1_Lay_Boi_Id_Chuyen_Thu_Truyen")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
...
#Region "Lay_Boi_Khach_Hang"
        ...
        End Function
#End Region
#Region "Lay_Boi_Tu_Ngay_Den_Ngay"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Lấy dữ liệu từ bảng Khach_Hang thông qua khóa chính 
        ' Input: Ma_KH
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function Lay_Boi_Tu_Ngay_Den_Ngay(ByVal Tu_Ngay As String, ByVal Den_Ngay As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Tu_Ngay_Den_Ngay", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Tu_Ngay_Den_Ngay")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
        ...
        End Function
#End Region
#Region "Lay_Boi_Tu_Ngay_Den_Ngay_Ma_KH"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Lấy dữ liệu từ bảng Khach_Hang thông qua khóa chính 
        ' Input: Ma_KH
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function Lay_Boi_Tu_Ngay_Den_Ngay_Ma_KH(ByVal Tu_Ngay As String, ByVal Den_Ngay As String, ByVal Ma_KH As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Tu_Ngay_Den_Ngay_Ma_KH", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Tu_Ngay_Den_Ngay_Ma_KH")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
...
#Region "E1_Den_Tam_Insert_To_E1_Den_KT"
        Public Sub E1_Den_Tam_Insert_To_E1_Den_KT(ByVal Id_E2 As String, ByVal Id_ca As String, ByVal Ma_Bc_Khai_Thac As Integer, ByVal Id_Nguoi_Dung As Integer)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
...
#Region "E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Ngay"
        ...
        ' Output: myDataTable
        Public Function E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Ngay(ByVal MA_E1 As String, ByVal Tu_Ngay As Integer, ByVal Den_Ngay As Integer) As Ems_Shipping_E1_Den_Tam_Chi_Tiet
            Try
                ' Tạo đối tượng connection và command
...
#End Region
#End Region
#Region "Phân hướng E1 tự động"
#Region "E1_Den_Tam_Chua_Phan_Huong"
        ' Ngày tạo: 08/01/09
        ' Người tạo: QĐô
        ' Nội dung: Lấy dữ liệu chưa phân hướng theo Id_Ca 
        ' Input: Id_Ca
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function E1_Den_Tam_Chua_Phan_Huong(ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Chua_Phan_Huong", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Chua_Phan_Huong")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
        ...
        End Function
#End Region
#Region "E1_Den_Tam_Chua_PH_Lay_Boi_Id_Duong_Thu_Id_Ca"
        ' Ngày tạo: 08/01/09
        ' Người tạo: QĐô
        ' Nội dung: Lấy dữ liệu chưa phân hướng theo Id_Ca 
        ' Input: Id_Ca
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function E1_Den_Tam_Chua_PH_Lay_Boi_Id_Duong_Thu_Id_Ca(ByVal Id_Duong_Thu As String, ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Chua_PH_Lay_Boi_Id_Duong_Thu_Id_Ca", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Chua_PH_Lay_Boi_Id_Duong_Thu_Id_Ca")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
        ...
        End Function
#End Region
#Region "E1_Den_Tam_Da_Phan_Huong"
        ' Ngày tạo: 08/01/09
        ' Người tạo: QĐô
        ' Nội dung: Lấy dữ liệu đã phân hướng theo Id_Ca 
        ' Input: Id_Ca
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function E1_Den_Tam_Da_Phan_Huong(ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Da_Phan_Huong", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Da_Phan_Huong")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
        ...
        End Function
#End Region
#Region "Cap_Nhat_Trang_Thai_Da_Phan_Huong"
        ' Ngày tạo: 15/6/08
        ' Người tạo: Nguyễn Bằng
        ' Nội dung: Cập nhật dữ liệu vào bảng E1_Den_Tam
        ' Input: Id_E1,  Id_Duong_Thu , Id_Chuyen_Thu , Id_E2 , Id_Ca , Ma_Bc_Khai_Thac , Ma_Quay , Ma_E1 , Ngay_Phat_Hanh , Gio_Phat_Hanh , Ngay_Dong , Gio_Dong , Ngay_Nhan , Gio_Nhan , Ma_Don_Vi , Ma_Bc_Goc , Ma_Bc_Tra , Nuoc_Nhan , Nuoc_Tra , Khoi_Luong , Phan_Loai , Loai_Hang_Hoa , Khoi_Luong_QD , Loai , Dv_Cong_Them , Dv_Gia_Tang , PPXD , Cuoc_PPXD , PostCode , Cuoc_PPVX , VAT , COD , Gia_Tri_Hang , Cuoc_COD , Cuoc_DV , Cuoc_Chinh , Cuoc_Giam , Cuoc_E1 , Kien_So , STT , Ma_KH , Nguoi_Gui , Nguoi_Nhan , Dia_Chi_Gui , Dia_Chi_Nhan , Dien_Thoai_Gui , Dien_Thoai_Nhan , HH_Phat_Hanh , HH_Phat_Tra , Ma_Bc_CH , Id_Nguoi_Dung , Id_Trang_Thai , Ghi_Chu , Truyen_Khai_Thac , Truyen_Doi_Soat , Ngay_He_Thong , Chot_SL ,
        ' Output: 
        Public Sub Cap_Nhat_Trang_Thai_Da_Phan_Huong(ByVal Id_E1 As String, ByVal Id_Duong_Thu As String, ByVal Id_Ca As String)
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Cap_Nhat_Trang_Thai_Da_Phan_Huong", myConnection)
        ...
        End Sub
#End Region
#Region "E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Duong_Thu_Id_Ca"
        ' Ngày tạo: 05/08/08
        ' Người tạo: Đỗ Quốc Khánh
        ' Nội dung: kiểm tra trùng dữ liệu trong cùng chuyến thư đóng đi
        ' Input: MA_E1, Id_Chuyen_Thu
        ' Output: myDataTable
        Public Function E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Duong_Thu_Id_Ca(ByVal MA_E1 As String, ByVal Id_Ca As String) As Ems_Shipping_E1_Den_Tam_Chi_Tiet
            Try
                ' Tạo đối tượng connection và command
                Dim myE1_Den_Tam_Chi_Tiet As New Ems_Shipping_E1_Den_Tam_Chi_Tiet
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Duong_Thu_Id_Ca", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Duong_Thu_Id_Ca")
                myConnection.Close()
                myConnection.Dispose()
        ...
        End Function
#End Region
#Region "E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Ca"
        ' Ngày tạo: 05/08/08
        ' Người tạo: Đỗ Quốc Khánh
        ' Nội dung: kiểm tra trùng dữ liệu trong cùng chuyến thư đóng đi
        ' Input: MA_E1, Id_Chuyen_Thu
        ' Output: myDataTable
        Public Function E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Ca(ByVal MA_E1 As String, ByVal Id_Ca As String) As Ems_Shipping_E1_Den_Tam_Chi_Tiet
            Try
                ' Tạo đối tượng connection và command
                Dim myE1_Den_Tam_Chi_Tiet As New Ems_Shipping_E1_Den_Tam_Chi_Tiet
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Ca", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Kiem_Tra_Trung_MA_E1_Id_Ca")
                myConnection.Close()
                myConnection.Dispose()
        ...
        End Function
#End Region
#Region "Danh_Sach_Id_Duong_Thu"
        ' Ngày tạo: 08/01/09
        ' Người tạo: QĐô
        ' Nội dung: Lấy dữ liệu chưa phân hướng theo Id_Ca 
        ' Input: Id_Ca
        ' Output: DataSet chứa toàn bộ dữ liệu lấy về 
        Public Function Danh_Sach_Id_Duong_Thu(ByVal Id_Ca As String) As DataSet
            Try
                ' Tạo đối tượng connection và command
                Dim myConnection As SqlConnection = New SqlConnection(ConnectionString)
                Dim myCommand As SqlCommand = New SqlCommand("E1_Den_Tam_Danh_Sach_Id_Duong_Thu", myConnection)
                Dim myAdapter As SqlDataAdapter = New SqlDataAdapter
                Dim myDataSet As DataSet = New DataSet
                ...
                myConnection.Open()
                myAdapter.SelectCommand = myCommand
                myAdapter.Fill(myDataSet, "E1_Den_Tam_Danh_Sach_Id_Duong_Thu")
                myConnection.Close()
                myConnection.Dispose()
                Return myDataSet
            Catch ex As Exception
